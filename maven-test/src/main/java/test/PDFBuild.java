...
public class PDFBuild {
    ...
    public static void buidPDF(String pdfFile, String imageFile, String waterMarkName,
                               int permission) {
        try {
    ...
    public static boolean createPDFFile(File file) {
        ...
        try {
            ...
            BaseFont bf = BaseFont.createFont();// 使用系统字体  
    ...
    public static void waterMark(String inputFile, String imageFile, String outputFile,
                                 String waterMarkName, int permission) {
        try {
            PdfReader reader = new PdfReader(inputFile);
            PdfStamper stamper = new PdfStamper(reader, new FileOutputStream(outputFile));

            BaseFont base = BaseFont.createFont();// 使用系统字体  
    ...
    public static void main(String[] args) {
        String imageFilePath = "/Users/chenwanhai/Documents/粉色.png"; // 水印图片路径  
        String pdfFilePath = "/Users/chenwanhai/Documents/itext.pdf"; // 文件生成路径  
